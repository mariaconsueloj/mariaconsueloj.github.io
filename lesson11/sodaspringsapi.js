...
function forecast() {
    const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=d177f9a2f10fb5fa6a90b89e06a479aa&units=imperial"
    fetch(apiURL)
    ...
    const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=d177f9a2f10fb5fa6a90b89e06a479aa&units=imperial"
    fetch(forecastURL)
        .then((response) => response.json())
        .then((jsObject) => {
            console.log(jsObject);
